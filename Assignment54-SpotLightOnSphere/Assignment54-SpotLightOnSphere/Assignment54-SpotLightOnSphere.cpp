...
GLfloat light1_defuse[] = { 1.0f,0.0f,0.0f,1.0f };
...
void initialize(void)
{
	...
	glLightfv(GL_LIGHT1, GL_DIFFUSE, light1_defuse);
	glLightfv(GL_LIGHT1, GL_POSITION, light1_position);
	
	
	// Attenuation - Property of light in which intencity goes on diminishing as the distance between the light and vertex increase
