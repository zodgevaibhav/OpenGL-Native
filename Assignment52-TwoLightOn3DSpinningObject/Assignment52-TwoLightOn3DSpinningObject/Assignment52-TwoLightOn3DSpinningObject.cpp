...
GLfloat light_red_position[] = { 2.0f,1.0f,1.0f,0.0f };
...
GLfloat light_blue_position[] = { -2.0f,1.0f,1.0f,0.0f };
...
void initialize(void)
{
	...
	glLightfv(GL_LIGHT1, GL_AMBIENT, light_blue_ambient);
	glLightfv(GL_LIGHT1, GL_DIFFUSE, light_blue_defuse);
