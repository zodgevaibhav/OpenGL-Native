...
void display(void)
{
	...
	for (GLfloat angle = 0.05f;angle < 3.14 * 1;angle = angle + 0.0005f)
	{
		...
		//************************ Eyes *****************************
		glColor3f(1.0f, 1.0f, 1.0f);
		glVertex3f(-0.15f + (cos(angle * 2 - 3.14f) / (5 * 3.14)), sin(angle * 2 - 3.14f) / (5 * 3.14), 0.0f); //left eye
		glVertex3f(0.15f + (cos(angle * 2 - 3.14f) / (5 * 3.14)), sin(angle * 2 - 3.14f) / (5 * 3.14), 0.0f); //right eye


		//************************ Mouth *****************************
		glColor3f(1.0f, 1.0f, 1.0f);
		glVertex3f((cos(angle - 3.14f) / (5 * 3.14)), -0.20 + sin(angle - 3.14f) / (5 * 3.14), 0.0f);
		
		//************************ chest *****************************
		glVertex3f((cos(angle  - 3.14f) / (5 * 3.14)), -0.35+sin(angle  - 3.14f) / (5 * 3.14), 0.0f);
		glColor3f(1.0f, 0.0f, 0.0f);
		glVertex3f((cos(angle - 3.14f) / (4 * 3.14)), -0.35 + sin(angle - 3.14f) / (4 * 3.14), 0.0f);
		glColor3f(0.0f, 1.0f, 0.0f);
		glVertex3f((cos(angle - 3.14f) / (3 * 3.14)), -0.35 + sin(angle - 3.14f) / (3 * 3.14), 0.0f);
