...
//**********************************  A   ***********************************************
	...
	glBegin(GL_LINES);
		glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(165), getRgbToGLfloat(0));
		glVertex3f(0.4f, 0.03f, 0);
		glVertex3f(0.6f, 0.03f, 0);

		glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(255), getRgbToGLfloat(255));
		glVertex3f(0.4f, 0.02f, 0);
		glVertex3f(0.6f, 0.02f, 0);

		glColor3f(getRgbToGLfloat(0), getRgbToGLfloat(255), getRgbToGLfloat(0));
		glVertex3f(0.4f, 0.01f, 0);
		glVertex3f(0.6f, 0.01f, 0);
	glEnd();
