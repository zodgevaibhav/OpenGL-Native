...
void display(void)
{
	...
	for (GLfloat i = 1.0;i < 10.0f;i=i+1)
	{
	drawCircleUsingPoints(3.14/(i/3),i);
	}
...
void drawCircleUsingPoints(GLfloat reduaceRadiosBy, int colorCode) {
	...
	GLfloat redCircle, greenCircle, blueCircle;
	getRgbColor(colorCode, &redCircle, &greenCircle, &blueCircle);
	glBegin(GL_POINTS);
	const float PI = 3.14;
