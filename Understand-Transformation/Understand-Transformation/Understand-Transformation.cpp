//************************** Understansing of glRotate + glTranslate + glPushMatrix + glPopMatrix
#include<windows.h>
#include<gl/GL.h>
...
void translateFirstAndThenRotate(void);
void rotateFirstAndTheTranslate(void);

bool flagTranslateFirst = true;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		{
		case 0X52: //R
			flagTranslateFirst= false;
			break;
		case 0X47: //G
			flagTranslateFirst = true;
			break;
		case 0X42: //B
			red = 0.0f;
			green = 0.0f;
...
void display(void)
{
	...
	//if (flagTranslateFirst)
	//{
	//	translateFirstAndThenRotate();
	//}
	//else
	//{
	//	rotateFirstAndTheTranslate();
	//}
...
void translateFirstAndThenRotate() 
{
	glBegin(GL_LINES);
...
void rotateFirstAndTheTranslate()
{
	glBegin(GL_LINES);
	glColor3f(0.0f, 0.0f, 0.0f);
