...
void display(void)
{
	...
	for (GLfloat angle = 0.05f;angle < 3.14 * 2;angle = angle + 0.0005f)
	{	
		glVertex3f(-0.7+cos(angle)/(3.14f*3.0f), 0.7+sin(angle)/ (3.14f*3.0f), 0.0f);

		glVertex3f(-0.4 + cos(angle) / (3.14f*2.5f), 0.6 + sin(angle) / (3.14f*2.50f), 0.0f);

		glVertex3f(-0.1 + cos(angle) / (3.14f*2.3f), 0.3 + sin(angle) / (3.14f*2.3f), 0.0f);

		glVertex3f(0.2 + cos(angle) / (3.14f*3.0f), 0.1 + sin(angle) / (3.14f*3.0f), 0.0f);

		glVertex3f(0.5 + cos(angle) / (3.14f*1.8f), -0.1 + sin(angle) / (3.14f*1.80f), 0.0f);

		//glVertex3f(-0.38f + (cos(angle * 2 - 3.14f) / (2 * 3.14)), sin(angle * 2 - 3.14f) / (5 * 3.14), 0.0f);
	}
	glEnd();
	SwapBuffers(ghdc);
}
