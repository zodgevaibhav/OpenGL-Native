...
void display(void)
{
	...
	//**********************************  I   ***********************************************
	if (firstIx < -0.8f) {
		firstIx = firstIx + 0.001f;
	}
	glBegin(GL_LINES);
		glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(165), getRgbToGLfloat(0));
		glVertex3f(firstIx, 0.9f, 0);
		glColor3f(getRgbToGLfloat(0), getRgbToGLfloat(255), getRgbToGLfloat(0));
		glVertex3f(firstIx, -0.9f, 0);
	glEnd();
	//**********************************  N   ***********************************************
	...
	glColor3f(getRgbToGLfloat(0), getRgbToGLfloat(255), getRgbToGLfloat(0));
	glVertex3f(-0.6f, nYaxis-1.8f, 0);

	glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(165), getRgbToGLfloat(0));
	glVertex3f(-0.4f, nYaxis, 0);
	glColor3f(getRgbToGLfloat(0), getRgbToGLfloat(255), getRgbToGLfloat(0));
	glVertex3f(-0.4f, nYaxis-1.8f, 0);
	...
	glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(165), getRgbToGLfloat(0));
	glVertex3f(0.2f, iYaxis, 0);
	glColor3f(getRgbToGLfloat(0), getRgbToGLfloat(255), getRgbToGLfloat(0));
	glVertex3f(0.2f, iYaxis-1.8f, 0);
	glEnd();
	...
	glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(165), getRgbToGLfloat(0));
	glVertex3f(aXAxis, 0.9f, 0);
	glColor3f(getRgbToGLfloat(0), getRgbToGLfloat(255), getRgbToGLfloat(0));
	glVertex3f(aXAxis-0.2f, -0.9f, 0);
	...
	if (aLineXAxisLast < 0.6)
	{
		aLineXAxisLast = aLineXAxisLast + 0.01f;
	}
	else if (aLineXAxisFirst < 0.4f)
	{
		aLineXAxisFirst = aLineXAxisFirst + 0.01f;
	}
	glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(165), getRgbToGLfloat(0));
	glVertex3f(aLineXAxisFirst, 0.03f, 0);
	glVertex3f(aLineXAxisLast, 0.03f, 0);

	glColor3f(getRgbToGLfloat(255), getRgbToGLfloat(255), getRgbToGLfloat(255));
	glVertex3f(aLineXAxisFirst, 0.02f, 0);
	glVertex3f(aLineXAxisLast, 0.02f, 0);

	glColor3f(getRgbToGLfloat(0), getRgbToGLfloat(255), getRgbToGLfloat(0));
	glVertex3f(aLineXAxisFirst, 0.01f, 0);
	glVertex3f(aLineXAxisLast, 0.01f, 0);
	glEnd();
...
GLfloat getRgbToGLfloat(int intRgbValue)
{
	return (1.00 / 256.00)*(GLfloat)intRgbValue;
}
